...
public abstract class PlaybackInfoListener {
    ...
    void onDurationChanged(int duration, SeekBar seekBar) {
    }

    void onPositionChanged(int position,boolean isSeeking,SeekBar mSeekbarAudio) {
    }

    void onStateChanged(@State int state) {
    }

    void onPlaybackCompleted(SeekBar mSeekbarAudio) {
    }
}